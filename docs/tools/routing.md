...
- Выберите сервис маршрутизации
  ...
  >Варианты:
  >
  > - `Velocat-Router`: доступен для всех. Используется собственный OSRM-сервер  
  ...
  !> Собственный Velocat-Router маршрутизатор в текушей версии использует для построения маршрутов **ТОЛЬКО** российские регионы.
