...
Использовать текстовые подсказки направлений при автопрокладке маршрута. Если отключено, подсказки (маневры) не рассчитываются и не отображаются. Остальные пункты будут недоступны для изменения.
