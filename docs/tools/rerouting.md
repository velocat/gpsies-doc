...
Использовать текстовые подсказки направлений при автопрокладке маршрута

#### 2. Отображать блок поворотов/направлений
Показывать на карте список поворотов и направлений маршрута.
Будет отображено в виде кнопки или списка, в зависимости от сохраненного состояния редактора.

#### 3. Сохранять инструкции в точках трека
Показывать на карте надписи для поворотов и направлений маршрута.

#### 4. Сохранять инструкции как отдельные точки
Сохранять инструкции как отдельные точки (WPT) для поворотов/направлений маршрута. Будут отображаться как маркеры.
