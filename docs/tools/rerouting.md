...
!><span style="color: red;">Важно!</span> Собственный Velocat-Router (маршрутизатор) в текушей версии использует для построения маршрутов <span style="color: red;">**ТОЛЬКО**</span> российские регионы.
