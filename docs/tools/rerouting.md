...
* Состояние синхронизировано кнопке включение/выключение подсказок в блоке-легенде "маршруты/маневры" и в конфигурации "Настройки маршрутизации" (т.е. при изменении в одном из этих мест, в остальных это состояние установится автоматически). 
