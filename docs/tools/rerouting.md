...
Сохранять инструкции в точках трека для поворотов/направлений маршрута.
К точке будут добавлены тэги cmt, namr, desc и символ sym соответствующий стандарту GARMIN:
```xml
      /*** Стандартная точка трека  ***/

      <trkpt lat="55.597970000" lon="38.178900000">
        <ele>138.240</ele>
      </trkpt>
      
      /*** Точка трека с информацией о маневре ***/

      <trkpt lat="55.598050000" lon="38.179050000">
        <ele>136.872</ele>
        <name>Поворот налево</name>
        <cmt>Поверните налево на Раменское шоссе</cmt>
        <desc>Поверните налево на Раменское шоссе</desc>
        <sym>Left</sym>
      </trkpt>
```
Современный устройства умеют считывать и отображать данные теги, они входят в стандарт GPX 1.1. Если у Вас старое устройство или по какой либо причине информации в устройстве не видно, воспользуйтесь создание отдельных маркеров с подсказками, см п.5 ниже 

#### 5. Сохранять инструкции как отдельные точки
Сохранять инструкции как отдельные точки (WPT) для поворотов/направлений маршрута. Будут отображаться как отдельные маркеры (WPT).
```xml
  <wpt lat="55.613420000" lon="38.157110000">
    <name>Направо</name>
    <cmt>Поверните направо</cmt>
    <desc>Поверните направо</desc>
    <sym>Right</sym>
    <type>trackpoint-1-91</type>
  </wpt>
```
