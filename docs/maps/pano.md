...
>[!DANGER]
>Данный раздел относится к версиям редактора ниже 3.3.4.  
>Начиная с версии 3.3.4 нижеописанные панорамы отключены из-за закрытия их правообладателями бесплатных лимитов, а также из-за блокировок в России.
>Используйте [Яндекс-панорамы](./ya_pano.md)
