...
- [NEW] При добавлении фотографий к треку, увеличены разрешенные размеры и вес файла фотографий
- [NEW] Автоматическое сжатие (оптимизация) фотографий к треку, если они превышают установленны лимит
