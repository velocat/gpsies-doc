...
- [ ] Рефакторинг кода (модульность)
- [x] Добавить Яндекс панорамы
- [x] Инструмент: Рероутер (построение маршрута по треку)
- [x] Инструмент: Оптимизатор трека
- [x] Информационные подсказки направлений и поворотов с сохранением в треке 
