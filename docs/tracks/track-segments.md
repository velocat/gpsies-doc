...
1. **Выделите фрагмент(участок) на активном сегменте для выбора действия с ним:**
   ...
   ![Image300](../_media/select-start.png)
...
1. **Выберите действие, которое хотите произвести с выделенным фрагментом:**
   ...
   ![Image300](../_media/fragment-1.png)
   ...
   - ***Удалить точки и разделить***  
     ...
     - ***Ремаршрутизатор и маневры*** 
     Экспериментальный инструмент, позволяющий проложить маршрут по любому треку с привязкой к существующим дорогам на карте OSM. 
     Для нового маршрута можно включить показ и сохранение в треке указателей поворотов и направлений (маневры).
     Подробная информация и описание этого инструмента: [Ремаршрутизатор](/tools/rerouting.md) 

     Пример использования:

      ![Image300](../_media/rerouter-preview.png)

     >[!WARNING] 
     >Инструмент ремаршрутизации экспериментальный. 
     >Обязательно проверяйте построенный маршрут и все установленные к нему подсказки к маневрам, прежде чем использовать его для навигации!
