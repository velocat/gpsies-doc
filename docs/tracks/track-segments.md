...
1. **Выберите действие, которое хотите произвести с выделенным фрагментом:**
   ...
   - ***Удалить точки и разделить***  
     ...
     >[!NOTE]
     >Инструмент экспериментальный. Обязательно проверяйте построенный маршрут и все установленные к нему подсказки к маневрам, прежде чем использовать его для навигации!
